...
class GradesTestSuite {
    ...
    //Pierwszy test weryfikuje, czy w nowym obiekcie Grades tablica z ocenami jest pusta.
    // Drugi sprawdza, czy po dodaniu dwóch ocen tablica ma odpowiedni rozmiar oraz czy znajdują się w niej dodane wartości
